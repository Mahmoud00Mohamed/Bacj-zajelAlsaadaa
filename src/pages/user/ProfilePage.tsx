        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-gray-800">{isRtl ? 'البريد الإلكتروني' : 'Email'}</h3>
              <div className="flex items-center justify-center gap-1">
                <CheckCircle size={14} className="text-green-500" />
                <p className="text-gray-600 text-sm">{isRtl ? 'موثق' : 'Verified'}</p>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-gray-800">{isRtl ? 'الهاتف' : 'Phone'}</h3>
              <div className="flex items-center justify-center gap-1">
                {profile?.isPhoneVerified ? (
                  ...
                  <>
                    ...
                    <p className="text-gray-600 text-sm">{isRtl ? 'غير موثق' : 'Not Verified'}</p>
                  </>
                )}
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-gray-800">{isRtl ? 'عضو منذ' : 'Member Since'}</h3>
